...
Opisane wcześniej przekształcenia nie są stosowane przez kompilator samoczynnie. Decyzja,które z nich zostaną wykonane, należy do twórcy oprogramownia. Do realizacji tych technik służą odpowiednie flagi kompilacji. Najczęściej wykorzystuje się w tym celu zbiorcze poziomy optymalizacji, oznaczane jako \texttt{-O0}, \texttt{-O1}, \texttt{-O2}, \texttt{-O3}, \texttt{-Os}, \texttt{-Oz}, \texttt{-Og} oraz \texttt{-Ofast}. W \cref{tab:poziomy_optymalizacji} zestawiono ogólne założenia stojące za każdym z tych poziomów, w postaci opisanej w dokumentacjach kompilatorów clang i gcc.

Warto podkreślić,że pod każdym z nich kryje się lista pojedynczych flag, odpowiadających konkretnym przekształceniom optymalizującym program wykonywalny. Flagi pozwalają wybrać zarówo najważniejsze przekształcenia opisane w \cref{section:TechnikiOptymalizacji}, jak i inne techniki opisane szerzej w literaturze \cite{Kompilatory_Aho}.
