...
\end{itemize}
Algorytm Cooleya-Tukeya był zaproponowany jako pierwszy, jednak z czasem powstały kolejne, tworzące dziś całą rodzinę algorytmów FFT. Wszystkie realizują to samo przekształcenie, czyli dyskretną transformatę Fouriera, różnią się natomiast wewnętrzymi mechanizmami, takimi jak podejście do podziału danych czy długości pojedyńczego bloku przetwarzanego sygnału \cite{ZielinskiDSP}.
...
Na algorytm w tej postaci składa się kilka podstawowych zagadnienien, omówionych kolejno w dalszej części podrozdziału: sposób podziału danych, uporządkowanie próbek przed rozpoczęciem obliczeń oraz elementarna operacja arytmetyczna, powtarzana na każdym etapie.
